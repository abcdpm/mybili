...
// 15. 定时全量更新所有视频播放量和时长
// ==========================================================================
// 作用：强制把数据库中所有有效的存量视频重新推入队列，获取B站最新的播放量。
// 频率：每周五凌晨 05:00 执行一次 (避开了 3:00 评论更新 和 4:00 收藏夹扫描)
Schedule::command('app:update-video-stats --force')
    ->name('update-all-video-stats')
    ->withoutOverlapping()
    ->fridays()
    ->at('05:00');