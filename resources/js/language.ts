...
const messages = {
    'zh-CN': {
        ...
        video: {
            ...
            visitSpace: '访问空间',
            deleteVideo: '删除视频',
            deleteVideoTitle: '删除视频确认',
            deleteVideoDescription: '你可以选择临时删除（仅删除本地文件）或永久删除（软删除并删除弹幕）。永久删除后不会再自动下载。',
            deletePermanentLabel: '永久删除（软删除视频记录、删除弹幕和本地视频文件）',
            deleteRequeueLabel: '删除后立即重新下载（仅临时删除可用）',
            deleteCancel: '取消',
            deleteConfirm: '确认删除',
            deleting: '处理中...',
            refreshDanmaku: '更新弹幕',
            refreshDanmakuTitle: '从服务器更新弹幕',
            refreshDanmakuDescSingle: '将立即从哔哩哔哩拉取当前分 P 的最新弹幕并合并到本地。',
            refreshDanmakuDescMulti: '共有 {count} 个分 P，将依次排队拉取弹幕：第 1P 立即执行，之后每一分 P 延迟 1 分钟，避免请求过于集中。',
            refreshDanmakuConfirm: '加入队列',
            refreshDanmakuQueuedSingle: '已加入队列，将立即更新弹幕。',
            refreshDanmakuQueuedMulti: '已加入 {count} 个弹幕更新任务，将按间隔依次执行。',
            refreshDanmakuError: '无法加入队列，请稍后重试。',
            refreshDanmakuNoParts: '没有可分 P，无法更新弹幕。',
            deleteSuccess: '视频已删除',
        ...
        settings: {
            ...
            filters: {
                ...
                customSize: '自定义大小',
                byDuration: '按视频时长排除',
                byDurationPart: '按分P时长排除',
                largerThan30min: '大于 30 分钟',
                largerThan60min: '大于 60 分钟',
                customDuration: '自定义时长(分钟)',
                before1Month: '排除 1 个月前收藏的视频',
                before3Month: '排除 3 个月前收藏的视频',
                before6Month: '排除 6 个月前收藏的视频',
                customDate: '排除自定义日期之前收藏的视频',
                enableFavoritesFilter: '启用收藏夹排除',
    ...
    'en-US': {
        ...
        about: {
            ...
            features: {
                ...
                commentsDownload: 'Automatic download of video comments data'
            },
        ...
        video: {
            ...
            deleteVideoDescription: 'You can remove local files only, or permanently delete (soft-delete record and remove danmaku). After permanent delete, the video will not be re-downloaded automatically.',
            deletePermanentLabel: 'Permanent delete (soft-delete record, remove danmaku and local video files)',
            deleteRequeueLabel: 'Re-queue download after delete (temporary delete only)',
            deleteCancel: 'Cancel',
            deleteConfirm: 'Delete',
            deleting: 'Working…',
            refreshDanmaku: 'Update danmaku',
            refreshDanmakuTitle: 'Refresh danmaku from server',
            refreshDanmakuDescSingle: 'The current part will fetch the latest danmaku from Bilibili and merge into local storage immediately.',
            refreshDanmakuDescMulti: 'This video has {count} parts. Jobs are queued in order: part 1 runs immediately, then each following part is delayed by 1 minute to avoid bursting the API.',
            refreshDanmakuConfirm: 'Queue jobs',
            refreshDanmakuQueuedSingle: 'Queued. Danmaku will update shortly.',
            refreshDanmakuQueuedMulti: 'Queued {count} danmaku jobs; they will run one minute apart.',
            refreshDanmakuError: 'Could not queue jobs. Please try again later.',
            refreshDanmakuNoParts: 'No playable parts — cannot refresh danmaku.',
        ...
        settings: {
            ...
            // 过滤设置
            filters: {
                byName: 'Exclude by Name',
                bySize: 'Exclude by Size',
                byFavorites: 'Exclude by Favorites',
                byFavoriteTime: 'Exclude by Favorite Time',
                noFilter: 'No Exclude',
                ...
                enableFavoritesFilter: 'Enable Favorites Exclude',
                selectExcludedFavorites: 'Select favorites to exclude:',
                byDuration: 'Exclude by Duration',
                byDurationPart: 'Exclude by Part Duration',
                largerThan30min: 'Larger than 30 minutes',
                largerThan60min: 'Larger than 60 minutes',
                customDuration: 'Custom Duration (minutes)',
                before1Month: 'Exclude videos favorited before 1 month ago',
                before3Month: 'Exclude videos favorited before 3 months ago',
                before6Month: 'Exclude videos favorited before 6 months ago',
                customDate: 'Exclude videos favorited before custom date',
            ...
            placeholders: {
                ...
                enterDate: 'Select date (YYYY-MM-DD)',
