...
docker build --build-arg APP_VERSION=1.1.6 -t llllalex/mybili:1.1.6 . --no-cache
docker push llllalex/mybili:1.1.6
docker tag llllalex/mybili:1.1.6 llllalex/mybili:latest
