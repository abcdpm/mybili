...
docker build --build-arg APP_VERSION=1.1.5 -t llllalex/mybili:1.1.5 . --no-cache
docker push llllalex/mybili:1.1.5
docker tag llllalex/mybili:1.1.5 llllalex/mybili:latest
