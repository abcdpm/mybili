...
docker build --build-arg APP_VERSION=1.1.9 -t llllalex/mybili:1.1.9 . --no-cache
docker push llllalex/mybili:1.1.9
docker tag llllalex/mybili:1.1.9 llllalex/mybili:latest
