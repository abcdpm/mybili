...
docker build --build-arg APP_VERSION=1.0.8 -t llllalex/mybili:1.0.8 . --no-cache
docker push llllalex/mybili:1.0.8
docker tag llllalex/mybili:1.0.8 llllalex/mybili:latest
