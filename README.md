...
docker build --build-arg APP_VERSION=1.1.1 -t llllalex/mybili:1.1.1 . --no-cache
docker push llllalex/mybili:1.1.1
docker tag llllalex/mybili:1.1.1 llllalex/mybili:latest
